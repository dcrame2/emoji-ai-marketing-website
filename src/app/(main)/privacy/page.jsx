    ...
    <Container>
      <div class="my-10">
        <h1 class="mb-6 text-center text-4xl font-bold">
          Privacy Policy for Emoji AI
        </h1>
        <p class="mb-4 text-lg font-semibold">
          <strong>Effective Date: January 4, 2025</strong>
        </p>

        <h2 class="mb-4 mt-6 text-2xl font-semibold">1. Introduction</h2>
        <p class="mb-4">
          Welcome to <strong>Emoji AI</strong> ("App"), a mobile application
          designed to turn your words into fun emojis. This Privacy Policy
          explains how we collect, use, disclose, and safeguard your information
          when you use our App. By using Emoji AI, you consent to the practices
        ...
        <p class="mb-4">
          Emoji AI does not knowingly collect personal information from children
          under the age of 13. If you are a parent or guardian and believe that
          your child has provided personal information, please contact us so we
          can delete it.
        </p>
        ...
        <p>
          <strong>Email:</strong>{' '}
          <a href="mailto:dcrame2@gmail.com" class="text-blue-500 underline">
            dcrame2@gmail.com
          </a>
        </p>
        <p>
          <strong>Address:</strong> 2345 W Monroe St APT 3E, Chicago, IL 60612,
          USA
        </p>

        <p class="mt-6 text-center font-semibold">
          By using Emoji AI, you agree to the terms outlined in this Privacy
          Policy.
        </p>
      </div>
    </Container>
